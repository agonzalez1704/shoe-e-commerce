...
// "524775690546" → "477 569 0546". El número se guarda en el formato que pide
...
const BRANDS: Record<string, BrandConfig> = {
  ...
  blade: {
    ...
    pdp: {
      ...
      shippingMadeToOrder: "Entrega en *4 a 7 días hábiles* a todo México.",

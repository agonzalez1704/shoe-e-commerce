-- El descuento de bienvenida no se acumula con el combo: gana el que más le
-- convenga al comprador.
--
-- `create_order` venia sumando los dos (`v_discount + ...`), asi que un pedido
-- de 2 pares con codigo de bienvenida se llevaba el combo Y otro 10% encima.
-- Solo cambia esa linea; firma, columnas de retorno y el resto del cuerpo son
-- identicos a 0053 — renombrar algo aqui tumba el checkout desplegado.
